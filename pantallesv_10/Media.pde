...
String[] materialsCreate = {"Arduino UNO", "RGB LED", "220 Ohm resistor", "Photoresistor", "Piezo", "Servo motor"};
String[] materialsFilters = {"Actuator", "Breadboard", "Button", "LEDs", "Resistor", "Sensor"};
