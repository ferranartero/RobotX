...
void inicialitzaBotons(){
  ...
  //TEXT AREAS
  createDescription = new TextArea(margeX+fotoPrevX + 50, height/2-fotoPrevX/2, width-2*margeX-fotoPrevX-50, 125, 100, 5);
  ...
  experiences.add(new ExperienceButton(imgs, 0, "NAME", descriptionBeta, procedureBeta, materialsBeta, codeBeta, 0));
  experiences.add(new ExperienceButton(imgs, 0, "NAME", descriptionBeta, procedureBeta, materialsBeta, codeBeta, 1));
  experiences.add(new ExperienceButton(imgs, 1, "NAME", descriptionBeta, procedureBeta, materialsBeta, codeBeta, 2));
  experiences.add(new ExperienceButton(imgs, 0, "HOLA", descriptionBeta, procedureBeta, materialsBeta, codeBeta, 3));
  experiences.add(new ExperienceButton(imgs, 0, "NAME", descriptionBeta, procedureBeta, materialsBeta, codeBeta, 4));
  experiences.add(new ExperienceButton(imgs, 2, "NAME", descriptionBeta, procedureBeta, materialsBeta, codeBeta, 5));
  experiences.add(new ExperienceButton(imgs, 0, "NAME", descriptionBeta, procedureBeta, materialsBeta, codeBeta, 6));
  experiences.add(new ExperienceButton(imgs, 1, "NAME", descriptionBeta, procedureBeta, materialsBeta, codeBeta, 7));
}
