...
void inicialitzaBotons(){
  ...
  experiences.add(new ExperienceButton(imgs, 0, "NAME", descriptionBeta, procedureBeta, materialsBeta, codeBeta, 0, 0));
  experiences.add(new ExperienceButton(imgs, 0, "NAME", descriptionBeta, procedureBeta, materialsBeta, codeBeta, 1, 1));
  experiences.add(new ExperienceButton(imgs, 1, "NAME", descriptionBeta, procedureBeta, materialsBeta, codeBeta, 2, 2));
  experiences.add(new ExperienceButton(imgs, 0, "HOLA", descriptionBeta, procedureBeta, materialsBeta, codeBeta, 3, 0));
  experiences.add(new ExperienceButton(imgs, 0, "NAME", descriptionBeta, procedureBeta, materialsBeta, codeBeta, 4, 3));
  experiences.add(new ExperienceButton(imgs, 2, "NAME", descriptionBeta, procedureBeta, materialsBeta, codeBeta, 5, 4));
  experiences.add(new ExperienceButton(imgs, 0, "NAME", descriptionBeta, procedureBeta, materialsBeta, codeBeta, 6, 5));
  experiences.add(new ExperienceButton(imgs, 1, "NAME", descriptionBeta, procedureBeta, materialsBeta, codeBeta, 7, 0));
}
