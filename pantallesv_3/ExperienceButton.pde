class ExperienceButton {
 ...
 // Mètode Constructor
 ExperienceButton(PImage img, int dif, String text, int ne){
   this.numExp = ne;
   this.img = img;
   this.dif = dif;
   if(dif == 0){
   ...
   this.description = "hola amics. HELLO WORLD. hola amics. HELLO WORLD. hola amics. HELLO WORLD. hola amics. HELLO WORLD. hola amics. HELLO WORLD. hola amics. HELLO WORLD. hola amics. HELLO WORLD. hola amics. HELLO WORLD. hola amics. HELLO WORLD. hola amics. HELLO WORLD. hola amics. HELLO WORLD. hola amics. HELLO WORLD. hola amics. HELLO WORLD. hola amics. HELLO WORLD. hola amics. HELLO WORLD. hola amics. HELLO WORLD. hola amics. HELLO WORLD. hola amics. HELLO WORLD";
 }
