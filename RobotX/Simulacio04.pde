...
class Simulacio04 extends Simulacio {
  ...
  void initGui() {
    ...
    // Sliders
    sX = new Slider("X Rotation", 475, 800, 300, 50, 0, 6.28, 0);
    sY = new Slider("Y Rotation", 825, 800, 300, 50, 0, 6.28, 0);
    sZ = new Slider("Z Rotation", 1175, 800, 300, 50, 0, 6.28, 0);
    
    sR = new Slider("Right Link", 725, 900, 300, 50, 0, 90, 0);
    sR.setColor(color(100, 100, 255));
    sL = new Slider("Left link", 1075, 900, 300, 50, 0, 90, 0);
  ...
  void display() {
    ...
    text("Closed Loop", width/2, 220);
    pushMatrix();    
    translate(width/2-75, 550); 
    //scale(2);
    rotateY(X_Rotation);  
    rotateX(Y_Rotation);
    rotateZ(Z_Rotation);
