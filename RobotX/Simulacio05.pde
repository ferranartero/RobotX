...
class Simulacio05 extends Simulacio {
  ...
  void initGui() {
    ...
    // Formes 3D
    L1 = loadShape("simula05/linkone.obj");
    L2= loadShape("simula05/linktwo.obj");
    L3= loadShape("simula05/linkthree.obj");
    L4= loadShape("simula05/linkfour.obj");
    base =loadShape("simula05/base.obj");

    // Sliders
    sX = new Slider("X Rotation", 450, 930, 300, 50, 0, 6.28, 0);
    sY = new Slider("Y Rotation", 800, 930, 300, 50, 0, 6.28, 0);
    sZ = new Slider("Z Rotation", 1150, 930, 300, 50, 0, 6.28, 0);

    sFR = new Slider("Front Right Link", 600, 830, 300, 50, 0, 50, 0);
    sFR.setColor(color(100, 100, 255));
    sFL = new Slider("Front Left Link", 250, 830, 300, 50, 0, 50, 0);
    sFL.setColor(color(100, 100, 255));

    sBR = new Slider("Back Right Link", 1300, 830, 300, 50, 0, 50, 0);
    sBR.setColor(color(100, 100, 255));
    sBL = new Slider("Back Left Link", 950, 830, 300, 50, 0, 50, 0);
  ...
  void display() {
    ...
    text("Robotic Lizard", width/2, 220);
    pushMatrix();    
