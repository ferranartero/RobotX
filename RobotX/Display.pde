...
void mouseCursor(){
  if(pantalla == Pantalles.INICI && create.enabled && create.mouseOverButton() || 
     ...
     pantalla == Pantalles.SIMULA03 && (s3.sA.mouseOnSlider() || s3.sB.mouseOnSlider() || s3.sS.mouseOnSlider() ||
                                        s3.sX.mouseOnSlider() || s3.sY.mouseOnSlider() || s3.sZ.mouseOnSlider())||
     pantalla == Pantalles.SIMULA04 && (s4.sL.mouseOnSlider() || s4.sR.mouseOnSlider() || s4.sX.mouseOnSlider() || s4.sY.mouseOnSlider() || s4.sZ.mouseOnSlider())||
     pantalla == Pantalles.SIMULA05 && (s5.sBL.mouseOnSlider() || s5.sBR.mouseOnSlider() || s5.sFL.mouseOnSlider() || s5.sFR.mouseOnSlider() || 
                                        s5.sX.mouseOnSlider() || s5.sY.mouseOnSlider() ||s5.sZ.mouseOnSlider())
     ){
        cursorHand = true;
     }else{
        cursorHand = false;
